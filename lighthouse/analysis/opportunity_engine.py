...
CATALOG = [
    {
        ...
        "impact": "High", "difficulty": "Low", "ai_automation": "High",
    },
    {
    ...
    },
    {
        ...
        "trigger": lambda c: not c.website_signals.customer_videos and not c.social.youtube,
        ...
        "impact": "High", "difficulty": "Medium", "ai_automation": "High",
    },
    {
        ...
        "impact": "Medium", "difficulty": "Low", "ai_automation": "Medium",
    },
    {
        ...
        "impact": "Medium", "difficulty": "Low", "ai_automation": "High",
    },
    {
    ...
    },
    {
        ...
        "impact": "Medium", "difficulty": "Medium", "ai_automation": "Medium",
    },
    {
        "title": "FAQ Page",
        ...
        "impact": "Low", "difficulty": "Low", "ai_automation": "High",
    },
    {
        ...
        "impact": "High", "difficulty": "Low", "ai_automation": "Medium",
    },
    {
    ...
    },
    {
        ...
        "impact": "Medium", "difficulty": "Medium", "ai_automation": "High",
    },
    {
        "title": "Case Studies",
...
def build_opportunities(company: RawCompany, top_n: int = 5) -> list:
    triggered = []
    for rule in CATALOG:
        if rule["trigger"](company):
            priority = _IMPACT_WEIGHT[rule["impact"]] / _DIFFICULTY_WEIGHT[rule["difficulty"]]
