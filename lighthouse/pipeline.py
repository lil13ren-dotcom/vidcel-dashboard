...
from lighthouse.models import RawCompany, ScoredCompany
...
def score_all(companies: list[RawCompany]) -> list[ScoredCompany]:
...
def run(
    raw_files: Optional[list[str]] = None, output_dir: str = OUTPUT_DIR
) -> list[ScoredCompany]:
